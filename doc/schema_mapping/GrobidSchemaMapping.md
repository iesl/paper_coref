...
2. Select all instances of ```<title>``` appearing inside an instance of ```<titleStmt>``` and concatent the values of these fields. Set the _title_ field of __RawCitation__ to this value.
3. Select all instances of ```<date>``` appearing inside an instance of ```<publicationStmt>``` and concatent the values of these fields. Set the _date_ field of __RawCitation__ to this value.
